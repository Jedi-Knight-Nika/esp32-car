...
void robot_setup()
{
  ...
  // Set up channels with the correct API for ESP32 v3.2.0
  ...
  ledc_channel_config_t ledc_channel_left_m0 = {
    .gpio_num = LEFT_M0,
    .speed_mode = LEDC_HIGH_SPEED_MODE,
  ...
  ledc_channel_config(&ledc_channel_left_m0);
  
  ledc_channel_config_t ledc_channel_left_m1 = {
    .gpio_num = LEFT_M1,
    .speed_mode = LEDC_HIGH_SPEED_MODE,
  ...
  ledc_channel_config(&ledc_channel_left_m1);
  
  ledc_channel_config_t ledc_channel_right_m0 = {
    .gpio_num = RIGHT_M0,
    .speed_mode = LEDC_HIGH_SPEED_MODE,
  ...
  ledc_channel_config(&ledc_channel_right_m0);
  
  ledc_channel_config_t ledc_channel_right_m1 = {
    .gpio_num = RIGHT_M1,
    .speed_mode = LEDC_HIGH_SPEED_MODE,
  ...
  ledc_channel_config(&ledc_channel_right_m1);
...
void update_speed()
{  
  ledc_set_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_0, get_speed(motor_speed));
  ledc_update_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_0);
  ledc_set_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_1, get_speed(motor_speed));
  ledc_update_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_1);
  ledc_set_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_2, get_speed(motor_speed));
  ledc_update_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_2);
  ledc_set_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_3, get_speed(motor_speed));
